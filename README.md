...
```
4. After that, you need to replace the placeholder on line 41 of the web/index.html file
```bash

<script src="https://maps.googleapis.com/maps/api/js?key=%GOOGLE_API_KEY_WEB%"></script>
```

with your own Google Maps API key.

You should also update the "current_key" field on line 18 of the android/app/google-services.json file with the same key.
